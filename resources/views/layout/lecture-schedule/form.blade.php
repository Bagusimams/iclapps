    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    @if($SubmitButtonText == 'View')
                        {!! Form::text('lecturer_id', $course->lecturer->name, array('class' => 'form-control', 'readonly' => 'readonly')) !!}
                    @else
                    ...
                    <div class="col-sm-6">
                        ...
                        @elseif($SubmitButtonText == 'Edit')
                            <div class="input-group date">
                                <input type="text" class="form-control pull-right" id="tanggal_praktek" name="date" value="{{ $course->date }}" onchange="getAvailableRoomByDate()">
                            </div>
                        @else
                            <div class="input-group date">
                                <input type="text" class="form-control pull-right" id="tanggal_praktek" name="date" onchange="getAvailableRoomByDate()">
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="bootstrap-timepicker">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        @else
                            <div class="input-group date">
                                {!! Form::text('start_time', null, array('class' => 'form-control timepicker', 'id' => 'start_time', 'onchange' => 'getRoomAvailable()')) !!}
        ...
        @if(isset($old))
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    {!! Form::label('sks', 'SKS of Subject', array('class' => 'col-sm-3 control-label')) !!}
                    <div class="col-sm-6">
                        {!! Form::text('sks', $old->sks, array('class' => 'form-control', 'readonly' => 'readonly')) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    {!! Form::label('lecturer_id', 'Lecturer', array('class' => 'col-sm-3 control-label')) !!}
                    <div class="col-sm-6">
                        {!! Form::text('lecturer_id', $old->lecturer->name, array('class' => 'form-control', 'readonly' => 'readonly')) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    {!! Form::label('day', 'Day', array('class' => 'col-sm-3 control-label')) !!}
                    <div class="col-sm-6">
                        {!! Form::text('day', $old->day, array('class' => 'form-control', 'readonly' => 'readonly')) !!}
                    </div>
                </div>
                ...
                <div class="bootstrap-timepicker">
                    <div class="form-group">
                        {!! Form::label('start_time', 'Start Time', array('class' => 'col-sm-3 control-label')) !!}
                        <div class="col-sm-6">
                            {!! Form::text('start_time', $old->start_time, array('class' => 'form-control', 'readonly' => 'readonly')) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="bootstrap-timepicker">
                    <div class="form-group">
                        {!! Form::label('end_time', 'End Time', array('class' => 'col-sm-3 control-label')) !!}
                        <div class="col-sm-6">
                            {!! Form::text('end_time', $old->end_time, array('class' => 'form-control', 'readonly' => 'readonly')) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    {!! Form::label('room_id', 'Room', array('class' => 'col-sm-3 control-label')) !!}
                    <div class="col-sm-6">
                        {!! Form::text('room_id', $old->room->name, array('class' => 'form-control', 'readonly' => 'readonly')) !!}
                    </div>
                </div>
            </div>
        @endif
...
@section('javascript-addon')
    ...
    <script>
        ...
        @else
            ...
            {
                console.log("{!! url($role . '/course/getAvailableRoomByDate/') !!}/" + $("#start_time").val() + '/' + $("#end_time").val() + '/' + $("#day").val());
                $.ajax({
                  url: "{!! url($role . '/course/getAvailableRoomByDate/') !!}/" + $("#start_time").val() + '/' + $("#end_time").val() + '/' + $("#day").val(),
                  success: function(result){
