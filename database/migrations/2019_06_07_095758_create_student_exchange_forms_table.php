...
class CreateStudentExchangeFormsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('student_exchange_forms', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('file_financial')
                  ->nullable();
            $table->integer('is_form_complete')
                  ->default(0)
                  ->nullable();
    ...
    {
        Schema::dropIfExists('student_exchange_forms');
    }
}
