...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Winter School List</li>
  </ol>
</section>
...
<section class="content">             
  <div class="box">
    <div class="box-body">
      <div class="col-sm-8">
          <a href="{{ url('/' . $role . '/winter-school/create') }}" class="btn btn-success col-sm-4">Add Winter School</a>
        ...
        <tbody id="table-course">
          @foreach($universities as $university)
            <tr>
              ...
              <td><a href="{{ url('/' . $role. '/winter-school/' . $university->id . '/edit') }}"><i class="fa fa-pencil-square-o orange"></i></a></td>
              <td>
                  ...
                  <form id="delete-form-{{$university->id}}" action="{{ url('/' . $role . '/winter-school/' . $university->id . '/delete') }}" method="POST" style="display: none;">
                      {{ csrf_field() }}
                      {{ method_field('DELETE') }}
                  </form></td>
            </tr>
...
@section('javascript-addon') 
  <script type="text/javascript">
    ...
    {
      var show       = $('#show').val();   
      window.location = window.location.origin + '/{{ $role }}/winter-school/' + show;
    }
  </script>
@endsection 