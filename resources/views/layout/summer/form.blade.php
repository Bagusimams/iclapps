    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                ...
                @else
                    {!! Form::select('eng_type', getSummerEng(), null, ['class' => 'form-control select2', 'style'=>'width: 100%']) !!}
                @endif
            </div>
        </div>
...
@elseif($SubmitButtonText == 'View')
    ...
    @else
        @if($exchange->final_report == null)
            <a href="{{ url('/' . $role . '/summer/' . $exchange->id . '/edit') }}" class="btn btn-success btn-flat btn-block form-control">Edit Summer School Program Form</a>
        @endif
